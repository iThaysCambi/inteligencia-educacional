...
| 📥 **Arquivo do Power BI (.pbix)** | Relatório completo com modelo de dados DAX, visuais e filtros | [![Download .pbix](https://img.shields.io/badge/Download-ENEM.pbix-F2C811?style=for-the-badge&logo=powerbi&logoColor=black)]("[C:\Users\USER\OneDrive\Área de Trabalho\GENERATION\GENDAY\ENEM (1).pbix"](https://drive.google.com/file/d/1O0i9_QCmtYjMuITiw5YdJEog-yyZs3Xa/view?usp=drive_link)) |
...
1. Faça o download do arquivo do projeto:
   * 📁 [Baixar ENEM.pbix via Google Drive]("[C:\Users\USER\OneDrive\Área de Trabalho\GENERATION\GENDAY\ENEM (1).pbix](https://drive.google.com/file/d/1O0i9_QCmtYjMuITiw5YdJEog-yyZs3Xa/view?usp=drive_link)")
